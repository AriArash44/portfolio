  ...
  return (
    <header>
      ...
      absolute top-16 sm:top-[50px] w-full sm:w-auto px-12 pointer-events-none">
        <img className="w-20 h-20 mt-4 sm:mt-0" src="/images/profile.svg" alt="Arash Asghari" />
        <h1 className="font-bold text-custom-gold" style={{fontFamily: 'caveat'}}>Arash Asghari</h1>
      </div>
    </header>
  );
}